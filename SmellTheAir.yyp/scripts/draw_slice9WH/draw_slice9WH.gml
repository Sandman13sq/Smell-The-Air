...
/// @arg sprite,x,y,w,h,color,alpha
/// draw_slice9WH(sprite,x,y,w,h,color,alpha)
function draw_slice9WH(argument0, argument1, argument2, argument3, argument4, argument5, argument6) {

	var _spr = argument0,
	    _x = argument1, _y = argument2,
	    _w = argument3, _h = argument4,
