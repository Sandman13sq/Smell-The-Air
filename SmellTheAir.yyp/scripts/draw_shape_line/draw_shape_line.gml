/// @description  Draws line with round edges
/// @arg x1,y1,x2,y2,width,color,alpha
/// draw_shape_line(x1,y1,x2,y2,width,color,alpha)
function draw_shape_line(argument0, argument1, argument2, argument3, argument4, argument5, argument6) {
	...
	for (var i = 0; i < 5; i++)
	{
	    draw_vertex_colour(_x1, _y1, _c, _a);
	...
	for (var i = 0; i < 5; i++)
	{
	    draw_vertex_colour(_x2, _y2, _c, _a);
